...
public class GajiKaryawanCalculator {
    private static HashMap<Golongan, Integer> GAJI_POKOK_RULE = new HashMap<>(Map.of(
        Golongan.A, 5000000,
        Golongan.B, 6000000,
        Golongan.C, 7000000,
        Golongan.D, 8000000
    ));
    private static float TUNJANGAN_SUAMI_ISTRI_PERCENTAGE = 10/100;
    private static float TUNJANGAN_PEGAWAI_PERCENTAGE = 15/100;
    private static float TUNJANGAN_ANAK_PERCENTAGE = 5/100;
    private static float POTONGAN_GAJI_PERCENTAGE = 25/1000;
